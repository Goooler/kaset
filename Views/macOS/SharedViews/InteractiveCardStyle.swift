...
// MARK: - GlassEffectContainerCompatible

/// A compatibility wrapper for GlassEffectContainer that works on macOS 15+.
/// It attempts to replicate the glass effect using standard SwiftUI materials.
public struct GlassEffectContainerCompatible<Content: View>: View {
    let spacing: CGFloat
    let content: Content
